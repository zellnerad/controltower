...
const ROBOTS_DATA = [
  {
    ...
    photo: (window.__resources?.assets_robot_topdown_png || "assets/robot-topdown.png"),
    log: [
    ...
    statePhotos: [
      { t: '15:42 today',  img: (window.__resources?.assets_flag_wardrobe_png || "assets/flag-wardrobe.png"),       tag: 'Wardrobe left open',  by: 'BILLIE-08',  severity: 'warn' },
      { t: 'yesterday',    img: (window.__resources?.assets_flag_door_png || "assets/flag-door.png"),           tag: 'Door ajar · F12 corridor', by: 'BILLIE-08', severity: 'info' },
      { t: '2d ago',       img: (window.__resources?.assets_flag_towels_png || "assets/flag-towels.png"),         tag: 'Towels on floor',     by: 'BILLIE-08',  severity: 'info' },
    ],
    parts: [
  ...
  },
  {
    ...
    statePhotos: [
      { t: '2m ago',       img: (window.__resources?.assets_flag_towels_png || "assets/flag-towels.png"),  tag: 'Stuck · towel rack',          by: 'BILLIE-12', severity: 'danger' },
      { t: 'yesterday',    img: (window.__resources?.assets_flag_white_curtain_png || "assets/flag-white-curtain.png"), tag: 'Curtain tangled · rm 1208', by: 'BILLIE-12', severity: 'warn' },
    ],
    parts: [
  ...
  },
  {
    ...
    statePhotos: [
      { t: '3d ago',   img: (window.__resources?.assets_flag_door_png || "assets/flag-door.png"),   tag: 'Scuff · chassis skirt', by: 'Tech · BE', severity: 'info' },
    ],
    parts: [
  ...
  },
  {
    ...
    statePhotos: [
      { t: '1d ago',   img: (window.__resources?.assets_flag_remote_control_png || "assets/flag-remote-control.png"), tag: 'Remote left on floor', by: 'BILLIE-15', severity: 'info' },
    ],
    parts: [
  ...
  },
  {
    ...
    statePhotos: [
      { t: '2h ago',   img: (window.__resources?.assets_map_scan_png || "assets/map-scan.png"),    tag: 'Map drift · F12', by: 'Tech · RM', severity: 'warn' },
    ],
    parts: [

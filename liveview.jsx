    ...
    <div style={{ position: 'absolute',
      ...
      <div style={{ position: 'relative', width: '100%', aspectRatio: '1 / 1',
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex',
          ...
          <img src="assets/robot-topdown.png" alt="Robot"
    ...
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      <div style={{ padding: '14px 14px 0', flexShrink: 0 }}>
        <div style={{ position: 'relative', borderRadius: 10, overflow: 'hidden',
          ...
          aspectRatio: '1.5 / 1' }}>
          {/* robot image */}
          <img src="assets/robot-topdown.png" alt="Robot top view"
    ...
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column',
      ...
      <div style={{ height: 48, flexShrink: 0, display: 'flex', alignItems: 'stretch',
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, paddingRight: 16, marginRight: 10,
          ...
          <img src="assets/billie-logo.png" alt="Billie"
            onError={(e) => { e.currentTarget.src = 'assets/billie-logo-white.png'; e.currentTarget.style.filter = 'invert(1)'; }}
...
// ═══════════════════════════════════════════════════════════════
const FLEET_FEEDS = [
  { id: 'F1', billie: 'BILLIE-08', cam: 'fwd',     room: 'rm 1216 · Rome',     time: '08:40', state: 'live',    site: 'Marriott Rome',     step: 'Bed · duvet replace',   pct: 72, accent: '#fbbf24', photo: 'assets/flag-remote-control.png' },
  { id: 'F2', billie: 'BILLIE-12', cam: 'fwd',     room: 'rm 1210 · Rome',     time: '04:12', state: 'live',    site: 'Marriott Rome',     step: 'Bathroom · towel fold', pct: 32, accent: '#fbbf24', photo: 'assets/flag-towels.png' },
  { id: 'F3', billie: 'BILLIE-03', cam: 'fwd',     room: 'rm 322 · Berlin',    time: '11:24', state: 'live',    site: 'Hilton Berlin',     step: 'Mini-bar · restock',    pct: 48, accent: '#fbbf24', photo: 'assets/flag-white-curtain.png' },
  { id: 'F4', billie: 'BILLIE-17', cam: '—',       room: 'service',            time: '—',     state: 'offline', site: 'Marriott Rome',     step: 'maintenance',           pct: 0,  accent: '#525252', photo: 'assets/flag-door.png' },
  { id: 'F5', billie: 'BILLIE-08', cam: 'arm',     room: 'rm 1216 · arm cam',  time: '08:40', state: 'live',    site: 'Marriott Rome',     step: 'grip · towel',          pct: 72, accent: '#fbbf24', photo: 'assets/flag-wardrobe.png' },
  { id: 'F6', billie: 'BILLIE-12', cam: 'arm',     room: 'rm 1210 · arm cam',  time: '04:12', state: 'live',    site: 'Marriott Rome',     step: 'cabinet · mini-bar',    pct: 32, accent: '#fbbf24', photo: 'assets/flag-door.png' },
  { id: 'F7', billie: 'BILLIE-21', cam: 'fwd',     room: 'rm 508 · Brussels',  time: '02:06', state: 'live',    site: 'Cardo Brussels',    step: 'Approaching 508',       pct: 12, accent: '#fbbf24', photo: 'assets/flag-white-curtain.png' },
  { id: 'F8', billie: 'BILLIE-14', cam: '—',       room: 'dock · charging',    time: '—',     state: 'offline', site: 'Hilton Berlin',     step: 'battery 41% → 100%',    pct: 0,  accent: '#525252', photo: 'assets/flag-wardrobe.png' },
  { id: 'F9', billie: 'BILLIE-05', cam: 'fwd',     room: 'rm 214 · Potsdam',   time: '06:18', state: 'live',    site: 'Seminaris Potsdam', step: 'Checkout · deep clean', pct: 54, accent: '#fbbf24', photo: 'assets/flag-remote-control.png' },
];
      ...
      <div style={{ flex: 1, minHeight: 0, overflow: 'hidden',
        ...
        {agentOpen ? (
          ...
          <button onClick={() => setAgentOpen(true)}
            ...
            <img src="billie-boss-logo.jpg" alt="Billie Boss"
      ...
      <div ref={scrollRef} style={{ flex: 1, overflow: 'auto', padding: '12px 16px',
        ...
        {messages.map((m, i) => m.role === 'agent' ? (
          <div key={i} style={{ display: 'flex', gap: 8, alignItems: 'flex-start' }}>
            <img src="billie-boss-logo.jpg" alt=""
  ...
  progress: {
    ...
    liveCards: [
      ...
      { n: '1216', billie: 'Billie-12', operator: 'M. Rivera',
        ...
        flags: [
          { label: 'remote control', img: 'assets/flag-remote-control.png' },
          { label: 'towels',         img: 'assets/flag-towels.png' },
          { label: 'white curtain',  img: 'assets/flag-white-curtain.png' },
          { label: 'door',           img: 'assets/flag-door.png' },
          { label: 'wardrobe',       img: 'assets/flag-wardrobe.png' },
        ] },
    ],
  },
  inspected: {
...
function LiveInspectionStrip({ goto }) {
  const FLAGS = [
    ...
    { label: 'towel rack',     img: 'assets/flag-towels.png',         robot: 'BILLIE-12', location: 'rm 1210 · bathroom',
      needsHelp: true, helpNote: "Stuck — can't reach the towel rack · 2m 14s" },
    { label: 'white curtain',  img: 'assets/flag-white-curtain.png',  robot: 'BILLIE-08', location: 'rm 1216 · window wall' },
    { label: 'door',           img: 'assets/flag-door.png',           robot: 'BILLIE-08', location: 'rm 1216 · entry' },
    { label: 'wardrobe',       img: 'assets/flag-wardrobe.png',       robot: 'BILLIE-08', location: 'rm 1216 · wardrobe' },
  ];
  return (
    <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,.08)',
      boxShadow: '0 1px 0 rgba(0,0,0,.04), 0 8px 24px -12px rgba(0,0,0,.35)',
  ...
  return (
    <aside style={{ width, flexShrink: 0, background: '#ffffff',
      ...
      <div style={{ padding: '14px 16px', borderBottom: '1px solid var(--border)',
        display: 'flex', alignItems: 'center', gap: 10 }}>
        <img src="billie-boss-logo.jpg" alt="" style={{ width: 26, height: 26, borderRadius: 13,
    ...
    <div style={{ flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column' }}>
      <div style={{ flex: 1, minHeight: 0, overflow: 'auto', padding: '14px 14px 6px',
        ...
        {msgs.map((m, i) => m.who === 'boss' ? (
          <div key={i} style={{ display: 'flex', gap: 8 }}>
            <img src="billie-boss-logo.jpg" alt="" style={{ width: 20, height: 20, borderRadius: 10,
    ...
    <div style={{ position: 'relative', height: '100%', background: '#0a0a0c', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'absolute', top: 0, bottom: 0, right: 0, width: SIDEBAR_W,
        ...
        <div style={{ padding: '14px 16px', borderBottom: '1px solid rgba(255,255,255,.08)',
          display: 'flex', alignItems: 'center', gap: 10 }}>
          <img src="billie-boss-logo.jpg" alt="Billie Boss" style={{ width: 26, height: 26, borderRadius: 13, objectFit: 'cover', background: '#fff' }}/>
          <div style={{ flex: 1, minWidth: 0 }}>
  ...
  const armInner = (
    <>
      ...
      <div style={{ position: 'relative', width: '100%', aspectRatio: '1.1 / 1',
        ...
        <img src="assets/arm-side.png" alt="Arm"
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1.6fr 1fr 380px', gap: 10, padding: 10, minHeight: 0 }}>
        ...
        <div style={{ background: '#12141a', border: '1px solid rgba(255,255,255,.08)',
          ...
          <div style={{ padding: '10px 14px', borderBottom: '1px solid rgba(255,255,255,.08)',
            display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
            <img src="billie-boss-logo.jpg" alt="Billie Boss" style={{ width: 28, height: 28, borderRadius: 14, objectFit: 'cover', background: '#fff' }}/>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 13, fontWeight: 600, color: '#fff' }}>Billie Boss</div>
